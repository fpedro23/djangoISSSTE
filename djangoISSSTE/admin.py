...
class AvancePorMunicipioAdmin(admin.ModelAdmin):
    ...
    # def get_utima_actualzizacion(self, obj):
    #     ultimaActualiacion = AvanceMensual.objects.filter(avancePorMunicipio_id=obj.id)
    #     print ultimaActualiacion
...
# admin.site.register(AvanceMensual, AvanceMensualAdmin)
