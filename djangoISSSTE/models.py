...
class MetaMensual(models.Model):
    ...
    ene = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    feb = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    mar = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    abr = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    may = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    jun = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    jul = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    ago = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    sep = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    oct = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    nov = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
    dic = models.DecimalField(max_digits=16, decimal_places=2, default=0, blank=False)
